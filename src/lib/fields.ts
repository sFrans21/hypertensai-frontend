  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        code: "ak02",
        hint: "Hari per minggu dengan aktivitas berat (mis. angkat beban, lari jarak jauh pada intensitas sedang, lari intensitas tinggi/sprint)",
        kind: "number",
        unit: "hari/minggu",
        min: 0,
        max: 7,
      ...
      },
      {
        ...
        code: "ak05",
        hint: "Hari per minggu dengan aktivitas sedang (mis. jogging, jalan cepat)",
        kind: "number",
        unit: "hari/minggu",
        min: 0,
        max: 7,
      ...
      },
      {
        ...
        code: "ak07",
        hint: "Total durasi beraktivitas fisik jika dirata-ratakan",
        kind: "number",
        unit: "menit/hari",
        min: 0,
        max: 1440,
